...
class simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, samp_rate/4, samp_rate, firdes.WIN_KAISER, 20))
        ...
        self.blocks_vector_source_x_1 = blocks.vector_source_c([0], True, 1, [])
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vcc((0.020, ))
        ...
        self.connect((self.foo_packet_pad2_0, 0), (self.low_pass_filter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.samp_rate/4, self.samp_rate, firdes.WIN_KAISER, 20))
