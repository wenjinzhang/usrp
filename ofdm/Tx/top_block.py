...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.band_pass_filter_0 = filter.fir_filter_ccf(1, firdes.band_pass(
        	1, 20e6, lowcut, highcut, 1e6, firdes.WIN_KAISER, 6.76))
    ...
    def set_lowcut(self, lowcut):
        self.lowcut = lowcut
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, 20e6, self.lowcut, self.highcut, 1e6, firdes.WIN_KAISER, 6.76))
