...
class ofdm_tx_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_tx_2")
        ...
        self.qtgui_time_sink_x_0.set_y_axis(0, packet_len)
...
def main(top_block_cls=ofdm_tx_2, options=None):
