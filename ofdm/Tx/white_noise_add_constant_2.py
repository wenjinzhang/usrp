...
# Title: White Noise Add Constant 2
...
class white_noise_add_constant_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "White Noise Add Constant 2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("White Noise Add Constant 2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "white_noise_add_constant_2")
        ...
        self.band_pass_filter_0_0 = filter.fir_filter_ccf(1, firdes.band_pass(
        	1, samp_rate, highcut*3, highcut*4, 1e6, firdes.WIN_KAISER, 6.76))
        ...
        self.connect((self.analog_noise_source_x_0, 0), (self.band_pass_filter_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(1, self.samp_rate, self.highcut*3, self.highcut*4, 1e6, firdes.WIN_KAISER, 6.76))
...
def main(top_block_cls=white_noise_add_constant_2, options=None):
