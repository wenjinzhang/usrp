...
class white_noise2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "White Noise2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("White Noise2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "white_noise2")
...
def main(top_block_cls=white_noise2, options=None):
