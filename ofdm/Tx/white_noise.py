...
class white_noise(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, setgain=0.95):
        ...
        self.band_pass_filter_0 = filter.fir_filter_ccf(1, firdes.band_pass(
        	1, 20e6, lowcut, highcut, 1e6, firdes.WIN_HAMMING, 6.76))
    ...
    def set_lowcut(self, lowcut):
        self.lowcut = lowcut
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, 20e6, self.lowcut, self.highcut, 1e6, firdes.WIN_HAMMING, 6.76))
