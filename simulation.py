...
from signal_generator_52subcarriers import generate_attack_signal
...
class simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._interval_range = Range(10, 1000, 1, 20, 200)
        ...
        self.channels_selective_fading_model_0 = channels.selective_fading_model( 8, 0/samp_rate, True, 1.0, 0, (0.0,0.1,1.3), (1,0.99,0.97), 8 )
        ...
        signal = signal * 0.1
        self.blocks_vector_source_x_1 = blocks.vector_source_c(signal, True, 1, [])
        ...
        self.connect((self.blocks_vector_source_x_1, 0), (self.blocks_add_xx_0, 1))
        ...
        self.connect((self.foo_packet_pad2_0, 0), (self.channels_selective_fading_model_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.channels_selective_fading_model_0.set_fDTs(0/self.samp_rate)
